...
(function () {
    var T = {
        ko: {
            ...
            'chess.white.win': '흰색(백)이 승리했습니다.',
            'chess.black.win': '검정(흑)이 승리했습니다.',
            ...
            'ak.variant.select': '게임 방식을 선택하세요',
            'ak.classic': '클래식', 'ak.classic.desc': '기본 알까기',
            'ak.extreme': '익스트림', 'ak.extreme.desc': '중앙 장애물 3개 추가',
            'ak.subtitle.classic': '구슬을 튕겨 상대를 밀어내세요',
            'ak.subtitle.extreme': '장애물을 피해 상대를 밀어내세요',
            'footer.home': '홈', 'footer.about': '게임 소개', 'footer.guides': '공략 모음', 'footer.contact': '문의', 'footer.privacy': '개인정보처리방침',
            ...
            'online.waiting': '상대를 기다리는 중입니다.',
            'online.paused': '상대의 연결이 끊겼습니다. 잠시 기다립니다.',
            'online.finished': '대국이 종료되었습니다.',
            'online.connected': '서버에 연결되었습니다.',
            'online.reconnecting': '연결이 끊겨 재접속 중입니다.',
            'online.opponentLeft': '상대의 연결이 끊겼습니다.',
            'online.opponentBack': '상대가 돌아왔습니다.',
            'online.starting': '게임을 시작합니다!',
            'online.rematchWait': '상대방이 재대결을 원합니다. "다시하기"를 눌러 수락하세요.',
            'online.rematchWaitingSelf': '상대방을 기다리는 중입니다...',
            'online.confirmLeaveMidGame': '게임을 종료하고 나가시겠습니까? 상대방은 대기 화면으로 돌아갑니다.',
            'online.err.roomFull': '이미 두 명이 대전 중인 방입니다.',
            'online.err.roomNotFound': '존재하지 않는 방 코드입니다.',
            'online.err.wrongGame': '다른 게임의 방 코드입니다.',
            'online.err.notYourTurn': '상대 차례입니다.',
            'online.err.cellTaken': '이미 돌이 놓인 자리입니다.',
            'online.err.seqMismatch': '판을 서버 기준으로 맞췄습니다.',
            'online.err.createFailed': '방 생성에 실패했습니다.',
            'online.err.replaced': '다른 창에서 같은 자리로 접속해 이 창의 연결이 종료되었습니다.',
            'online.err.codeLength': '6자리 코드를 입력하세요.',
        },
        en: {
            ...
            'chess.white.win': 'White wins.',
            'chess.black.win': 'Black wins.',
            ...
            'ak.variant.select': 'Choose a game style',
            'ak.classic': 'Classic', 'ak.classic.desc': 'Standard Alkkagi',
            'ak.extreme': 'Extreme', 'ak.extreme.desc': '3 obstacles in the center',
            'ak.subtitle.classic': 'Flick marbles to knock out your opponent',
            'ak.subtitle.extreme': 'Dodge the obstacles and knock them out',
            'footer.home': 'Home', 'footer.about': 'About', 'footer.guides': 'Guides', 'footer.contact': 'Contact', 'footer.privacy': 'Privacy Policy',
            ...
            'online.paused': 'Your opponent disconnected. Waiting a moment…',
            'online.finished': 'The match has ended.',
            'online.connected': 'Connected to the server.',
            'online.reconnecting': 'Connection lost. Reconnecting…',
            'online.opponentLeft': 'Your opponent disconnected.',
            'online.opponentBack': 'Your opponent is back.',
            'online.starting': 'Starting the game!',
            'online.rematchWait': 'Your opponent wants a rematch. Click "Rematch" to accept.',
            'online.rematchWaitingSelf': 'Waiting for your opponent…',
            'online.confirmLeaveMidGame': 'End the game and leave? Your opponent will return to the waiting room.',
            'online.err.roomFull': 'This room already has two players.',
            'online.err.roomNotFound': "This room code doesn't exist.",
            'online.err.wrongGame': 'This code belongs to a different game.',
            'online.err.notYourTurn': "It's your opponent's turn.",
            'online.err.cellTaken': 'That spot is already taken.',
            'online.err.seqMismatch': 'Synced the board with the server.',
            'online.err.createFailed': 'Failed to create the room.',
            'online.err.replaced': 'This tab was disconnected because the same seat connected from another tab.',
            'online.err.codeLength': 'Enter a 6-character code.',
        }
    };
